...
################################
# Шейкерная сортировка, также известная как сортировка по методу перемешивания или шейкерная сортировка с отбрасыванием
...
################################################################№
# алгоритм "сортировки расчёской": от O(n^2) до O(nlogn) / memory O(1)
...
################################
# Сортировка выбором (Selection sort) является простым алгоритмом сортировки, который состоит из повторения следующих
...
#############№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№
# Быстрая сортировка слиянием (merge sort) — это алгоритм, который разделяет исходный список на две части, рекурсивно сортирует каждую часть,
...
# Повторять шаги 2-4, пока размер кучи больше 1.Преимущества пирамидальной сортировки:
# Эффективна на практике и дает стабильную временную сложность O(n*logn).Не требует дополнительной памяти для сортировки
# Подходит для сортировки больших наборов данных.Недостатки пирамидальной сортировки:
# Неустойчива, что означает, что порядок равных элементов после сортировки может быть нарушен.
# Временная сложность в худшем случае всегда будет O(n*logn), даже для уже отсортированных данных.
def heapify(arr, n, i):
    largest = i
    left = 2 * i + 1
    right = 2 * i + 2
